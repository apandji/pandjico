...
- **Scope & stories:** [docs/user-stories-and-scope.md](docs/user-stories-and-scope.md)
- **Active tasks (single queue for remote work):** [docs/next-actions.md](docs/next-actions.md)
