# Instrument: Collections (All Works)

**URL:** `projects/index.html` · **Former filename:** `feature-all-works.md`
...
**Station role:** **Collections** instrument — [station-concept-and-critique.md](./station-concept-and-critique.md) (Part One · instruments; Part Two § Works Page).  
**Owner:** Andrew  
**Related:** [README.md](./README.md), [station-concept-and-critique.md](./station-concept-and-critique.md) Part Three, [next-actions.md](./next-actions.md) (active queue), `index.html`, `projects/index.html`, `projects/projects.json`, `js/works-index.js`, `js/work-cards.js`
