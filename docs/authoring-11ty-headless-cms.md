...
This keeps the **public site static** while making **writing** the long pole faster—see [station-concept-and-critique.md](./station-concept-and-critique.md) Part Three (content stories) and [next-actions.md](./next-actions.md) (SYNEK slug).
